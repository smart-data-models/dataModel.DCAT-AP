...
endPointDescription = ['SPARQL end point without authentication', 'API compliant with CKAN specification']
attribute = "endPointDescription"
value = endPointDescription
# The next line creates the query for inserting this attribute in a NGSI-LD context broker if the attribute does not exist it creates it
print(sdm.update_broker(dataModel, subject, attribute, value, serverUrl=serverUrl, updateThenCreate=True))

endPointURL = ['urn:ngsi-ld:DataServiceDCAT-AP:items:AFGI:79071729', 'urn:ngsi-ld:DataServiceDCAT-AP:items:JAZP:97999812']
