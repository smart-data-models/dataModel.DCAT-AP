...
catalog = ['urn:ngsi-ld:Catalogue:items:LZMQ:44249979', 'urn:ngsi-ld:Catalogue:items:PECX:02526105']
attribute = "catalog"
value = catalog
...
dataset = ['urn:ngsi-ld:Catalogue:dataset:ZBCW:95668818']
attribute = "dataset"
value = dataset
# The next line creates the query for inserting this attribute in a NGSI-LD context broker if the attribute does not exist it creates it
print(sdm.update_broker(dataModel, subject, attribute, value, serverUrl=serverUrl, updateThenCreate=True))

hasPart = ['urn:ngsi-ld:Catalogue:hasPart:GVZM:66676591']
attribute = "hasPart"
value = hasPart
# The next line creates the query for inserting this attribute in a NGSI-LD context broker if the attribute does not exist it creates it
print(sdm.update_broker(dataModel, subject, attribute, value, serverUrl=serverUrl, updateThenCreate=True))
